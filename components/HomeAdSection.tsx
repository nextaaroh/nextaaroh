...
export default function HomeAdSection() {
  ...
  return (
    <div className="px-4 my-4">
      <Link href={"/marketplace/" + product.slug} className="relative rounded-xl overflow-hidden aspect-[16/7] block bg-gray-100">
        ...
        <div className="absolute bottom-0 p-3">
          ...
          <p className="text-white text-sm font-medium mt-1 line-clamp-2">{product.title}</p>
        </div>
      </Link>
    </div>
  );

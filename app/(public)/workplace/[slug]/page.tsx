...
type Listing = { title: string; organization: string; description: string; location: string | null; apply_link: string | null };
...
export default function WorkplaceDetailPage() {
  ...
  return (
    <div className="max-w-md mx-auto p-4">
      ...
      {listing.apply_link ? (
        <a href={listing.apply_link} target="_blank" rel="noopener noreferrer" className="block text-center bg-orange-500 text-white font-semibold py-3 rounded-lg">
          Apply Now
        </a>
      ) : null}
    </div>

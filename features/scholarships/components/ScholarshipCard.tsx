...
type Scholarship = { id: string; slug: string; title: string; provider: string; deadline: string | null; official_url: string };
  ...
  return (
    <div className="border border-gray-200 rounded-xl p-4">
      <div className="flex items-start justify-between gap-2">
        ...
        <button type="button" onClick={handleSave} disabled={saved} className="text-xl shrink-0">{saved ? "❤️" : "🤍"}</button>
      </div>
